...
const Header = () => {
  ...
  return (
    <header className="grid grid-cols-[90%,10%] bg-gradient-to-r from-emerald-200">
      ...
      <div className="pt-10">
        <a onClick={toggleDarkAndLightMode} href="#_" className="relative inline-block px-4 py-2 font-medium group">
          ...
          <span className="relative text-black group-hover:text-slate-200">{mode ? "Dark" : "Light"}</span>
        </a>
      </div>
    </header>
  );
